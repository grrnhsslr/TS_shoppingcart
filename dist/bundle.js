...
class User {
    ...
    createCart() {
        this._cart = this._cart.sort((a, b) => {
        ...
        if (this.cart.length === 0) {
            ...
            for (let i of cartSet) {
                ...
                cartDiv === null || cartDiv === void 0 ? void 0 : cartDiv.append(cartCard);
            }
        }
        let total = document.createElement('h2');
        total.innerHTML = `Total: ${this.cartTotal()}`;
        cartDiv === null || cartDiv === void 0 ? void 0 : cartDiv.append(total);
    }
    cardForCart(item, quantity) {
        let mainDiv = document.createElement('div');
        let title = document.createElement('h3');
        let subhead = document.createElement('p');
        let removeQuantity = document.createElement('button');
...
class Shop {
    ...
    forSale() {
        ...
        for (let i of this.items) {
            ...
            shopDiv === null || shopDiv === void 0 ? void 0 : shopDiv.append(shopItem);
        }
    }
    static shopCard(item) {
        let mainDiv = document.createElement('div');
        ...
        add.addEventListener('click', () => {
            var _a;
            (_a = Shop.myUser) === null || _a === void 0 ? void 0 : _a.addToCart(item);
        });
...
loginButton.addEventListener('click', (e) => {
    ...
    if (!user) {
        ...
        document.getElementById('age').placeholder = 'please enter a valid age';
    }
    else {
